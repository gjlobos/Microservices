...
import com.facturacion.configuration.feign.OAuthFeignConfig;
...
@FeignClient(name= "users-service",url = "http://users-service:8085", configuration = OAuthFeignConfig.class)
